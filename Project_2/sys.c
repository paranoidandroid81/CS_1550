...
//Begin CS1550 Project 2 Code

DEFINE_SPINLOCK(sem_lock);						//spin lock for atomicity

//node struct for linked list process queue
struct proc_node
{
	struct proc_node* next;			//next process in linked list
